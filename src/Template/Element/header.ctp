                ...
                <!-- Nav -->
                    <nav id="nav">
                        ...
                        <?php
                            ...
                            ?>
                            <a href="/categoria/index/ovnis-y-extraterrestres" alt="Ovnis y extraterrestres reales"><i title="Ovnis y extraterrestres reales" class="fa fa-reddit-alien" aria-hidden="true"></i><span style="display:none;" class="iconoTexto">Ovnis Reales</span></a>
