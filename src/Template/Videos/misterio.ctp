        ...
        <div class="container">
            <div class="row">
                <div class="9u 12u(mobile)">
                    <!-- Main Content -->
                    <section>
                        <?php echo $this->element('publicidadMisterioNativeArticulo'); ?>
                        ...
                        <?php } ?>
                        <?php echo $this->element('facebooks', ['categoria_id' => $video['categoria']['id']]); ?>
                        ...
                        <p class="resetP">
                            ...
                            <?= 
                                $this->Html->link(
                                    '¿qué son ' . $video['categoria']['nombre'] . ' y por qué?',
                        ...
                        <?php echo $this->element('tabs', array('amp' => false)); ?>
                        <?php echo $this->element('publicidadMisterioNativeArticulo'); ?>
                    </section>
                </div>
                    ...
                    <section class="publicidad-movil-columna-derecha">
                            <?php 
                                /*if (isset($video->libro_afiliado_1) && !empty($video->libro_afiliado_1) || isset($video->libro_afiliado_2) && !empty($video->libro_afiliado_2)) {
                                    ...
                                    //echo "<h3>";
                                        echo $this->element('publicidadMisterioArticulosListados');
                                    //echo "</h3>";
                               //}
                            ?>
                    </section>
