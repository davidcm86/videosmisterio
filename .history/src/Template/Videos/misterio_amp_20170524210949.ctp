        ...
        <div class="container">
            <div class="row">
                <div class="9u 12u(mobile)">
                    ...
                    <!-- Main Content -->
                    <section>
                        <a href="/" class="no-text-decoration"><p class="tituloMisterioAmp">Videos de Misterio</p></a>
                        ...
                        <amp-img  src="<?php echo $rutaImagen; ?>" alt="<?php echo $video->keywords; ?>"  height="44px" width="60px"></amp-img>
