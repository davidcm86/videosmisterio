                ...
                <!-- Nav -->
                    <nav id="nav">
                        ...
                        <?php
                            ...
                            ?>
                            <a href="/categoria/index/ovnis-y-extraterrestres" title="Ovnis y extraterrestres reales" alt="Ovnis y extraterrestres reales">
                                <img style="margin-top:-5px;" src="/img/cara-ovni.png">
                            </a>
