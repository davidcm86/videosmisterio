                ...
                <!-- Nav -->
                    <nav id="nav">
                        ...
                        <?php
                            ...
                            ?>
                            <a href="/logout" alt="Salir de Videos Misterio"><i title="Ovnis y extraterrestres reales" class="fa fa-reddit-alien" aria-hidden="true"></i><span style="display:none;" class="iconoTexto">Desconectar</span></a>
