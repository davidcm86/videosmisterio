                ...
                <!-- Nav -->
                    <nav id="nav">
                        ...
                        <?php
                            ...
                            ?>
                            <a href="/categoria/index/ovnis-y-extraterrestres" title="Ovnis y extraterrestres reales" alt="Ovnis y extraterrestres reales"><span style="display:none;" class="iconoTexto">
                                <img scr="/img/cara-ovni.png">
                            </span></a>
